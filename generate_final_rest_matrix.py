...
print("============================================================================================================================")
print(f"{'MÓDULO / TAG':<20} | {'GET':<4} | {'GET ID':<6} | {'POST':<5} | {'PUT':<4} | {'DELETE':<6} | {'RUTA REAL':<40} | {'ESTADO REST'}")
print("-" * 124)
...
for tag, resources in resources_map.items():
    for res_path, data in resources.items():
        ...
        print(f"{tag:<20} | {get_st:<4} | {get_id_st:<6} | {post_st:<5} | {put_st:<4} | {del_st:<6} | {res_path:<40} | {status}")
