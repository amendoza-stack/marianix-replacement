...
# CARGA DE MAIN.PY DESDE SU RUTA FÍSICA EXACTA
try:
    ...
    print(f"❌ Error al cargar main.py directamente: {e}")
    sys.exit(1)

print("====================================================================================================")
print("             INFORME DE AUDITORÍA ARQUITECTÓNICA DE ROUTERS (CARGA DIRECTA REAL)                    ")
print("====================================================================================================")
